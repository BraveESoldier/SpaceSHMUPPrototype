...
/// <summary>
/// Это перечесление всех возможных
/// Также включает тип "shield", чтобы дать возможность совершенствовать защиту
/// Аббревиатура НР ниже отмечены элементы, не реализованные
/// </summary>
...
public class Weapon : MonoBehaviour
{
    ...
    public float lastShotTime; //Время послденего выстрела
    ...
    void Start()
    {
        ...
        //Найти fireDelegate в корневом игровом объект
    ...
    public void SetType (WeaponType wt)
    {
        ...
        lastShotTime = 0; //Сразу после установки „type можно выстрелиnm
    }
