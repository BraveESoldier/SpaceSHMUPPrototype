...
public class Hero : MonoBehaviour
{
    ...
    //Эта переменная хранит ссылку на послдений столкнувшийся игровой обьект
    ...
    void Start()
    {
        ...
        //Очистить массив веапонс и наччать игру с 1 бластером
        ClearWeapons();
        weapons[0].SetType(WeaponType.blaster);
        //else
        //{
        //    Debug.LogError("Hero.Awake() - Attemped to assing secomd Hero.S!");
        //}
    }
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        else
        {
            ...
            {
                print("Triggered bby non-Enemy " + go.name);
            }
        }
    }
